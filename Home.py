...
# --- VEILIGE HTML CODE ---
# De textwrap.dedent() functie stript automatisch alle foute spaties weg die je editor per ongeluk toevoegt!
html_layout = textwrap.dedent("""
    <style>
    ...
    /* Jouw vrachtwagen foto is hier ingesteld! */
...
# We printen het nu veilig naar het scherm
