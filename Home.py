...
# =========================================================
# 1. DATABASE, COOKIES & TAAL (LANGUAGE) CHECKER
# =========================================================
cookie_manager = stx.CookieManager()

# --- TAAL LOGICA ---
# Welke taal stond er in de cookie? (Standaard Noors 'no')
saved_lang = cookie_manager.get('dahle_lang')
if 'language' not in st.session_state:
    st.session_state.language = saved_lang if saved_lang else "no"

# Heeft de gebruiker net op een vlaggetje geklikt?
...
if st.session_state.user is None and acc_token and ref_token:
    with st.spinner("Laster inn konto... ⏳" if st.session_state.language == "no" else "Loading account... ⏳"): 
        time.sleep(0.5) 
        try:
...
# =========================================================
# 2. HET WOORDENBOEK (TRANSLATIONS)
# =========================================================
translations = {
    "no": {
        "nav_home": "Hjem",
        ...
        "nav_contact_btn": "TA KONTAKT",
        "hero_title": "D ÅRNE SÆ!",
        "hero_subtitle": "Rask og sikker transport, uansett distanse.",
        "open_title": "Åpningstider:",
        "open_days": "Mandag-fredag: 07:00-16:00",
        "open_note": "Åpningstidene kan avvike ved spesielle høytider.",
        "btn_order": "BESTILL"
    },
    "en": {
        "nav_home": "Home",
        ...
        "hero_title": "WE'VE GOT IT!",
        "hero_subtitle": "Fast and secure transport, regardless of distance.",
        "open_title": "Opening Hours:",
...
# Activeer de juiste taal uit het woordenboek
t = translations[st.session_state.language]


# =========================================================
# 3. BEPAAL DE TEKST VOOR DE NAVBAR (MET ICOONTJE)
# =========================================================
...
.lang-btn {{ font-size: 18px; text-decoration: none; margin-left: 5px; opacity: 0.6; transition: 0.2s;}}
...
<div class="navbar">
    ...
    <div class="nav-cta">
        <div style="margin-right: 15px; display: flex; gap: 8px;">
            <a href="?lang=no" class="lang-btn {'lang-active' if st.session_state.language == 'no' else ''}" title="Norsk">🇳🇴</a>
            <a href="?lang=en" class="lang-btn {'lang-active' if st.session_state.language == 'en' else ''}" title="English">🇬🇧</a>
        </div>
