...
html_code = textwrap.dedent("""
    ...
    /* --- VERBERG ALLE STREAMLIT BRANDING & MENU'S --- */
    [data-testid="collapsedControl"], [data-testid="stSidebar"], header[data-testid="stHeader"] { display: none !important; }
    [data-testid="stToolbar"] { display: none !important; } /* Verbergt de rechterbovenhoek menu's */
    footer { display: none !important; } /* Verbergt de 'Made with Streamlit' tekst */
    div[class^="viewerBadge"] { display: none !important; } /* Verbergt de rode boot / kat! */
    #viewerBadge_container__1jcJt { display: none !important; } /* Extra check voor de boot */
