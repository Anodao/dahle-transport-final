...
translations = {
    ...
    "en": {
        ...
        "msg_creating": "Creating account...", "msg_reg_succ": "Account created successfully! You can now log in via the 'Log In' tab.", "msg_reg_fail": "An error occurred or email already exists.", "msg_fill_req": "Please fill in all mandatory fields (*).",
    ...
    "sv": {
        ...
        "street": "Gatuadress", "btn_save": "Spara ändringar", "msg_saving": "Uppdaterar profil...", "msg_save_succ": "Profilen har uppdaterats!", "msg_save_fail": "Kunde inte uppdatera profil:"
    },
    "da": {
        ...
        "msg_logging_in": "Logger ind...", "msg_login_succ": "Succesfuldt logget ind! Videresender...", "msg_login_fail": "Forkert e-mail eller adgangskode.", "msg_fill_both": "Udfyld venligst begge felter.",
        ...
        "msg_creating": "Opretter konto...", "msg_reg_succ": "Konto oprettet! Du kan nu logge ind via fanen 'Log ind'.", "msg_reg_fail": "Der opstod en fejl, eller e-mailen findes allerede.", "msg_fill_req": "Udfyld venligst alle obligatoriske felter (*).",
