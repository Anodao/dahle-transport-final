...
translations = {
    "no": { "nav_home": "Hjem", "nav_about": "Om oss", "nav_services": "Tjenester", "nav_gallery": "Galleri", "nav_contact": "Kontakt", "menu_title": "Sider ⌄", "menu_dash": "Performance Dashboard", "menu_plan": "Intern Planner", "menu_login": "Kundeportal", "menu_order": "Ny bestilling", "nav_portal": "KUNDEPORTAL", "nav_contact_btn": "TA KONTAKT", "fuel_lbl": "Diesel (per Liter)", "gas_lbl": "Bensin (per Liter)", "perf_sum": "### Oppsummering", "filter_lbl": "Filtrer etter dato:", "opt_all": "Alle bestillinger", "opt_today": "I dag", "opt_week": "Denne uken", "opt_lweek": "Forrige uke", "opt_month": "Denne måneden", "opt_custom": "Egendefinert dato...", "tot_fuel": "Total Drivstoffkostnad", "tot_profit": "Total Fortjeneste", "avg_margin": "Gjennomsnittlig margin", "co2_foot": "CO₂ Fotavtrykk", "act_ship": "Aktive Forsendelser", "prof_cust": "### Lønnsomhet per Kunde", "prof_trend": "### Fortjenesteutvikling", "det_brk": "### Detaljert Kostnads- og Marginsoversikt", "info_calc": "Hvordan beregnes fortjeneste? Fortjeneste = Estimert inntekt - Drivstoffkostnader. Margin % viser prosentandelen av inntekten som er fortjeneste.", "shipments": "FORSENDELSER", "fuel_cost": "DRIVSTOFF", "net_profit": "NETTO FORTJENESTE", "margin": "MARGIN %", "btn_view": "Se Bestillinger", "last_order": "Siste bestilling:", "unknown": "Ukjent", "dialog_title": "Ordrehistorikk og Detaljer", "dialog_sub": "Her er en oversikt over alle fullførte bestillinger for denne spesifikke kunden.", "route": "Rute:", "profit": "Fortjeneste:", "margin_lbl": "Margin:", "dash_title": "Performance Dashboard", "dash_sub": "Intern oversikt over lønnsomhet og utslipp" },
    "en": { "nav_home": "Home", "nav_about": "About us", "nav_services": "Services", "nav_gallery": "Gallery", "nav_contact": "Contact", "menu_title": "Pages ⌄", "menu_dash": "Performance Dashboard", "menu_plan": "Internal Planner", "menu_login": "Customer Portal", "menu_order": "New Order", "nav_portal": "CUSTOMER PORTAL", "nav_contact_btn": "CONTACT US", "fuel_lbl": "Diesel (per Liter)", "gas_lbl": "Petrol (per Liter)", "perf_sum": "### Performance Summary", "filter_lbl": "Filter by date:", "opt_all": "All orders", "opt_today": "Today", "opt_week": "This week", "opt_lweek": "Last week", "opt_month": "This month", "opt_custom": "Custom date...", "tot_fuel": "Total Fuel Cost", "tot_profit": "Total Profit", "avg_margin": "Avg. Margin", "co2_foot": "CO₂ Footprint", "act_ship": "Active Shipments", "prof_cust": "### Profitability per Customer", "prof_trend": "### Profit Trend Over Time", "det_brk": "### Detailed Cost & Margin Breakdown", "info_calc": "How is profit calculated? Profit = Estimated Revenue - Fuel Costs. The Margin % shows the percentage of revenue that remains as profit.", "shipments": "SHIPMENTS", "fuel_cost": "FUEL COST", "net_profit": "NET PROFIT", "margin": "MARGIN %", "btn_view": "View Orders", "last_order": "Last order:", "unknown": "Unknown", "dialog_title": "Order History & Details", "dialog_sub": "Here is the overview of all completed orders for this specific customer.", "route": "Route:", "profit": "Profit:", "margin_lbl": "Margin:", "dash_title": "Performance Dashboard", "dash_sub": "Internal overview of profitability and emissions" },
    "sv": { "nav_home": "Hem", "nav_about": "Om oss", "nav_services": "Tjänster", "nav_gallery": "Galleri", "nav_contact": "Kontakt", "menu_title": "Sidor ⌄", "menu_dash": "Performance Dashboard", "menu_plan": "Intern Planner", "menu_login": "Kundportal", "menu_order": "Ny beställning", "nav_portal": "KUNDPORTAL", "nav_contact_btn": "KONTAKTA OSS", "fuel_lbl": "Diesel (per Liter)", "gas_lbl": "Bensin (per Liter)", "perf_sum": "### Prestandasammanfattning", "filter_lbl": "Filtrera efter datum:", "opt_all": "Alla beställningar", "opt_today": "I dag", "opt_week": "Denna vecka", "opt_lweek": "Förra veckan", "opt_month": "Denna månad", "opt_custom": "Anpassat datum...", "tot_fuel": "Total bränslekostnad", "tot_profit": "Total vinst", "avg_margin": "Genomsnittlig marginal", "co2_foot": "CO₂ Fotavtryck", "act_ship": "Aktiva Försändelser", "prof_cust": "### Lönsamhet per Kund", "prof_trend": "### Vinstutveckling över tid", "det_brk": "### Detaljerad Kostnads- och Marginalöversikt", "info_calc": "Hur beräknas vinsten? Vinst = Uppskattad intäkt - Bränslekostnader.", "shipments": "FÖRSÄNDELSER", "fuel_cost": "BRÄNSLE", "net_profit": "NETTOVINST", "margin": "MARGINAL %", "btn_view": "Visa Beställningar", "last_order": "Senaste beställning:", "unknown": "Okänd", "dialog_title": "Orderhistorik och Detaljer", "dialog_sub": "Här är en översikt över alla slutförda beställningar.", "route": "Rutt:", "profit": "Vinst:", "margin_lbl": "Marginal:", "dash_title": "Performance Dashboard", "dash_sub": "Intern översikt över lönsamhet och utsläpp" },
    "da": { "nav_home": "Hjem", "nav_about": "Om os", "nav_services": "Tjenester", "nav_gallery": "Galleri", "nav_contact": "Kontakt", "menu_title": "Sider ⌄", "menu_dash": "Performance Dashboard", "menu_plan": "Intern Planner", "menu_login": "Kundeportal", "menu_order": "Ny bestilling", "nav_portal": "KUNDEPORTAL", "nav_contact_btn": "KONTAKT OS", "fuel_lbl": "Diesel (pr. Liter)", "gas_lbl": "Benzin (pr. Liter)", "perf_sum": "### Resultatoversigt", "filter_lbl": "Filtrer efter dato:", "opt_all": "Alle bestillinger", "opt_today": "I dag", "opt_week": "Denne uge", "opt_lweek": "Sidste uge", "opt_month": "Denne måned", "opt_custom": "Brugerdefineret dato...", "tot_fuel": "Samlede Brændstofomkostninger", "tot_profit": "Samlet Fortjeneste", "avg_margin": "Gennemsnitlig margin", "co2_foot": "CO₂ Fodaftryk", "act_ship": "Aktive Forsendelser", "prof_cust": "### Lønsomhed pr. Kunde", "prof_trend": "### Fortjenesteudvikling over tid", "det_brk": "### Detaljeret Omkostnings- og Marginoversigt", "info_calc": "Hvordan beregnes fortjeneste? Fortjeneste = Estimeret indtægt - Brændstofomkostninger.", "shipments": "FORSENDELSER", "fuel_cost": "BRÆNDSTOF", "net_profit": "NETTO FORTJENESTE", "margin": "MARGIN %", "btn_view": "Se Bestillinger", "last_order": "Seneste bestilling:", "unknown": "Ukendt", "dialog_title": "Ordrehistorik og Detaljer", "dialog_sub": "Her er en oversigt over alle gennemførte bestillinger.", "route": "Rute:", "profit": "Fortjeneste:", "margin_lbl": "Margin:", "dash_title": "Performance Dashboard", "dash_sub": "Intern oversigt over lønsomhed og udledning" }
}
...
def get_live_fuel_prices():
    try:
        data = requests.get("https://api.collectapi.com/gasPrice/europeanCountries", headers={'authorization': "apikey 40xj3EeeCTOZVeAjO2pEmj:7sLuMmcz7WUnrEdHaGiXyR", 'content-type': "application/json"}).json()
        for c in data.get('result', []):
            if c['country'].lower() == 'norway': return {"diesel": round(float(c['diesel'].replace(',', '.')) * 11.5, 2), "gas": round(float(c['gasoline'].replace(',', '.')) * 11.5, 2)}
    except: pass
...
try: df = pd.DataFrame(supabase.table("orders").select("*").execute().data)
...
with c_filter:
    ...
    custom_dates = st.date_input("Select date:", value=today) if filter_optie == t['opt_custom'] else []

filtered_df = df.copy()
if 'parsed_date' in df.columns:
    if filter_optie == t['opt_today']: filtered_df = df[df['parsed_date'] == today]
    elif filter_optie == t['opt_week']: filtered_df = df[df['parsed_date'] >= (today - timedelta(days=today.weekday()))]
    elif filter_optie == t['opt_lweek']: filtered_df = df[(df['parsed_date'] >= (today - timedelta(days=today.weekday()) - timedelta(days=7))) & (df['parsed_date'] < (today - timedelta(days=today.weekday())))]
    elif filter_optie == t['opt_month']: filtered_df = df[df['parsed_date'] >= today.replace(day=1)]
    elif filter_optie == t['opt_custom'] and len(custom_dates) == 2: filtered_df = df[(df['parsed_date'] >= custom_dates[0]) & (df['parsed_date'] <= custom_dates[1])]
...
k2.metric(t['tot_profit'], f"{filtered_df['profit'].sum():,.0f} NOK", delta=f"{avg_margin:.1f}% {t['avg_margin']}")
...
with col_left:
    ...
    fig_profit = px.bar(filtered_df.groupby('company')['profit'].sum().reset_index().sort_values('profit', ascending=False), x='company', y='profit', color_discrete_sequence=['#c48bd6'], template="plotly_dark")
...
with col_right:
    ...
    if 'parsed_date' in filtered_df.columns:
        fig_line = px.line(filtered_df.groupby('parsed_date')['profit'].sum().reset_index().rename(columns={'parsed_date': 'date'}), x='date', y='profit', markers=True, color_discrete_sequence=['#27ae60'], template="plotly_dark")
...
customer_group = filtered_df.groupby('company').agg(total_orders=('id', 'count'), total_fuel=('fuel_cost', 'sum'), total_profit=('profit', 'sum'), avg_margin=('margin_pct', 'mean'), last_date=('parsed_date', 'max')).reset_index().sort_values(by='last_date', ascending=False).reset_index(drop=True)
card_col1, card_col2 = st.columns(2)
for i, row in customer_group.iterrows():
    target_col = card_col1 if i % 2 == 0 else card_col2
    with target_col:
        with st.container(border=True):
            mc = "#27ae60" if row['avg_margin'] > 85 else "#e67e22"
            ld = row['last_date'].strftime('%Y-%m-%d') if pd.notnull(row['last_date']) else t['unknown']
            st.markdown(f"""<div style="padding-bottom: 10px;"><div style="font-size: 18px; font-weight: 700; color: #ffffff; margin-bottom: 5px; border-bottom: 2px solid #333; padding-bottom: 8px;">{row['company']} <span style="font-size: 13px; color: #888; font-weight: 400; float: right; margin-top: 4px;">{t['last_order']} {ld}</span></div><div style="display: flex; justify-content: space-between; text-align: center; margin-top: 15px;"><div style="flex: 1;"><div style="font-size: 12px; color: #b0b0b0; font-weight: 600;">{t['shipments']}</div><div style="font-size: 16px; font-weight: 700; color: #fff;">{row['total_orders']}</div></div><div style="flex: 1;"><div style="font-size: 12px; color: #b0b0b0; font-weight: 600;">{t['fuel_cost']}</div><div style="font-size: 16px; font-weight: 700; color: #fff;">{row['total_fuel']:,.0f} NOK</div></div><div style="flex: 1;"><div style="font-size: 12px; color: #b0b0b0; font-weight: 600;">{t['net_profit']}</div><div style="font-size: 16px; font-weight: 700; color: #27ae60;">{row['total_profit']:,.0f} NOK</div></div><div style="flex: 1;"><div style="font-size: 12px; color: #b0b0b0; font-weight: 600;">{t['margin']}</div><div style="font-size: 16px; font-weight: 700; color: {mc};">{row['avg_margin']:.1f}%</div></div></div></div>""", unsafe_allow_html=True)
            if st.button(t['btn_view'], key=f"popup_{row['company']}", use_container_width=True): show_order_history(row['company'], filtered_df)
